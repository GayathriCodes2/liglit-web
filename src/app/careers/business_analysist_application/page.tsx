...
export default function BusinessAnalystPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.contact.match(/^\+?\d{10,16}$/)) newErrors.contact = "Contact must be 10–16 digits";
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (validateForm()) {
      console.log("Business Analyst Application:", formData);
      setShowSuccess(true);
          ...
          <div className="grid lg:grid-cols-2 gap-10 xl:gap-16">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10 border border-gray-100">
              <div className="flex items-center gap-4 mb-8">
                ...
                <HoverHeading as='h3' className="text-2xl md:text-3xl font-bold text-gray-900">
                  Business Analyst
                </HoverHeading>
              </div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "Analyze workflows and identify improvement areas.",
                  "Translate business needs into technical specifications.",
                  "Conduct stakeholder meetings and requirement sessions.",
                  "Create BRD, SRS, and process documentation.",
                  "Perform gap analysis for existing systems.",
                  "Collaborate with developers, testers, and designers.",
                  "Support project planning and task breakdown.",
                  "Prepare user stories and acceptance criteria.",
                  "Validate solutions and ensure requirement alignment.",
                  "Conduct UAT planning and coordinate testing.",
                  "Generate reports and insights for decision-making.",
                  "Map business processes using diagrams and models.",
                  "Assess project risks and suggest mitigation steps.",
                  "Monitor project progress and requirement changes.",
                  "Communicate updates clearly to stakeholders.",
                  "Work closely with QA to confirm functionality.",
                  "Identify opportunities for automation and optimization.",
                  "Support product roadmap and feature prioritization.",
                  "Ensure the final deliverable meets business objectives.",
                ].map((item, i) => (
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (nums.length <= 16) setFormData({ ...formData, contact: nums });
                    }}
