...
export default function FrontendCareerPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (validateForm()) {
      console.log("Frontend Application Submitted:", formData);
      setShowSuccess(true);
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10 border border-gray-100">
              <div className="flex items-center gap-4 mb-8">
                <div className="p-3 bg-amber-100 rounded-lg">
                  <CodeBracketIcon className="w-8 h-8 text-amber-600" />
                </div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "Implement accessibility and responsive design standards.",
                  "Participate in code reviews for quality improvement.",
                  "Follow Agile/Scrum development methodology.",
                  "Stay updated with modern frontend trends and best practices.",
                  "Work with modern frameworks like Vite or Next.js.",
                  "Enhance UI using animations and smooth transitions.",
                  "Write unit tests using Jest/React Testing Library.",
                  "Maintain project structure and adhere to coding guidelines.",
