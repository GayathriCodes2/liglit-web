// app/careers/devops/page.tsx  (or any route you prefer)
"use client";
...
export default function DevOpsEngineerPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (validateForm()) {
      console.log("DevOps Engineer Application:", formData);
      setShowSuccess(true);
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10 border border-gray-100">
              <div className="flex items-center gap-4 mb-8">
                <div className="p-3 bg-amber-100 rounded-lg">
                  <ServerIcon className="w-8 h-8 text-amber-600" />
                </div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "Deploy and maintain cloud infrastructure (AWS, GCP, Azure).",
                  "Automate infrastructure using Terraform, Ansible, or CloudFormation.",
                  "Containerize applications with Docker and orchestrate using Kubernetes.",
                  "Monitor systems with Prometheus, Grafana, ELK stack, etc.",
                  "Implement security best practices and compliance standards.",
                  "Manage Git workflows, branching, and release strategies.",
                  "Optimize infrastructure cost and performance.",
                  "Set up logging, alerting, and incident response systems.",
                  "Collaborate with development teams for smooth deployments.",
                  "Troubleshoot production issues and perform root cause analysis.",
                  "Maintain high availability and disaster recovery plans.",
                  "Work with Jenkins, GitLab CI, GitHub Actions, or CircleCI.",
