...
export default function FullStackCareerPage() {
    ...
    const validateForm = () => {
        ...
        if (!formData.contact.match(/^\+?\d{10,16}$/)) newErrors.contact = "Valid contact number (10-16 digits)";
                        ...
                        <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10 border border-gray-100">
                            ...
                            <ul className="space-y-3">
                                {[
                                    ...
                                    "Build responsive and interactive UI components in React.",
                                    "Create and manage scalable backend APIs and services.",
                                    "Design efficient database schemas and queries in MongoDB.",
                                    "Implement both client-side and server-side logic.",
                                    ...
                                    "Troubleshoot, debug, and fix issues across the stack.",
                                    "Write clean, modular, and maintainable code.",
                                    "Conduct thorough code reviews and follow best practices.",
                                    "Collaborate with designers, product managers, and QA teams.",
                                    "Maintain version control using Git and GitHub workflows.",
                                    "Deploy and manage applications on cloud platforms (AWS, Vercel, DigitalOcean).",
                                    "Work with RESTful APIs and modern integration patterns.",
                                    "Follow agile methodologies and participate in sprint activities.",
                                    "Stay updated with new MERN stack tools and advancements.",
                                    "Implement reusable components and shared libraries.",
                                    "Test application functionality using unit and integration tests.",
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onWheel={(e) => (e.target as HTMLInputElement).blur()} // Disable scroll
